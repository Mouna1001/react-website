...
export default withFormik({
  ...
  validationSchema: Yup.object().shape({
    ...
    phone:Yup.string().min(10,'Please provide your 10 digit phone number.').max(15,'Your phone number is too longer.').required('We need a phone number to reach at.'),
    message:Yup.string().min(50,'You need to provide us more detailed information.').required('Message is required.')
  }),
